...
class RegisterButtonUser extends StatefulWidget {
  ...
  @override
  State<RegisterButtonUser> createState() => _RegisterButtonUserState();
}

class _RegisterButtonUserState extends State<RegisterButtonUser> {
  @override
